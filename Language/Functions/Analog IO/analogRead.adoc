...
Die Eingangsbreite kann mit link:../analogreference[analogReference()] geändert werden, die Auflösung mit link:../../zero-due-mkr-family/analogreadresolution[analogReadResolution()] (Nur für Arduino Zero, Due und MKR).
